...
import { ResponsiveArticleGrid } from "@/components/ResponsiveArticleGrid";
  ...
  return (
    <div className="min-h-screen bg-premium-gray-50 dark:bg-gray-900">
      ...
      <main className={`${isMobile ? 'pb-20' : 'pb-8'}`}>
        {isDesktop ? (
          // Desktop Layout: 75% content + 25% sidebar
          <div className="container mx-auto px-4 py-8">
            <div className="flex gap-8">
              ...
              <div className="flex-1">
                ...
                <section className="mb-12">
                  <h2 className="headline-premium text-headline-lg text-az-black dark:text-white font-bold mb-6 animate-fade-in">
                    Laatste Nieuws
                  </h2>
                  ...
                  {isLoading ? (
                    ...
                    <>
                      <ResponsiveArticleGrid articles={articles} />
          ...
          // Tablet Layout: 100% content, sidebar below
          <div className="container mx-auto px-4 py-8">
            {/* Next Match Widget */}
